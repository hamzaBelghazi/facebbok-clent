  ...
  return (
    <div className="new_post_container">
      <div className="input">
        ...
        <button className="add_post">What's on your mind , Hamza?</button>
      </div>
      <div className="spirator"></div>
      <div className="shorts">
        <div className="live_video button">
          <svg fill="/f3425f" viewBox="0 0 24 24">
        ...
        <div className="upload_img_video button">
        ...
        <div className="feeling_activity button">
          <svg fill="#f7b928" viewBox="0 0 24 24">
            <g fillRule="evenodd" transform="translate(-444 -156)">
              <g>
                <path
